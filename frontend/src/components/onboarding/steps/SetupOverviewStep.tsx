...
export function SetupOverviewStep() {
  ...
  return (
    <OnboardingContainer
      ...
      description="LibreMeet requires that you download the Transcription & Summarization AI models for the software to work."
      step={2}
      ...
      <div className="flex flex-col items-center space-y-10">
        ...
        <div className="w-full max-w-xs space-y-4">
          ...
          <div className="text-center">
            <a
              href="https://github.com/libremeet/libremeet"
              target="_blank"
