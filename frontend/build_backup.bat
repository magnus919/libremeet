@echo off
REM LibreMeet Build Script for Windows
...
echo 🚀 Building LibreMeet application...
...
echo.
echo ========================================
echo    LibreMeet Build Script - Help
echo ========================================
echo.
echo USAGE:
...
echo.
echo DESCRIPTION:
echo   This script builds the LibreMeet Tauri application for Windows.
