# GPU-accelerated development script for LibreMeet (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for LibreMeet" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting LibreMeet in development mode..." -ForegroundColor Blue
Write-Host ""
