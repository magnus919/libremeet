...
- Artifacts prefixed with `libremeet-test-`
...
```
libremeet-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `libremeet-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `libremeet-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `libremeet-macos-aarch64-release-0.1.3`
